"""Prerequisite check for the ollama_qwen3_30b_a3b candidate. Run before benchmark.py.

Verifies the Ollama server is reachable and the qwen3:30b-a3b model has
been pulled. Does NOT install Ollama or pull the model itself - both are
multi-GB downloads that should be a deliberate, explicit step (see this
directory's README.md), not a side effect of running a check.
"""
